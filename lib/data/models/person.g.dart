...
void _personSerialize(
  ...
  writer.writeBool(offsets[3], object.showBalance);
}
...
Person _personDeserialize(
  ...
  object.showBalance = reader.readBool(offsets[3]);
  return object;
}
...
extension PersonQueryFilter on QueryBuilder<Person, Person, QFilterCondition> {
  QueryBuilder<Person, Person, QAfterFilterCondition> balanceEqualTo(
    double value, {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> balanceGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> balanceLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> balanceBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> isArchivedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> showBalanceEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension PersonQuerySortBy on QueryBuilder<Person, Person, QSortBy> {
  QueryBuilder<Person, Person, QAfterSortBy> sortByBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.desc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByIsArchived() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isArchived', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByIsArchivedDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterSortBy> sortByShowBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showBalance', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByShowBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PersonQuerySortThenBy on QueryBuilder<Person, Person, QSortThenBy> {
  QueryBuilder<Person, Person, QAfterSortBy> thenByBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> thenByBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.desc);
    });
  }
  ...
  QueryBuilder<Person, Person, QAfterSortBy> thenByIsArchived() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isArchived', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> thenByIsArchivedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isArchived', Sort.desc);
    });
  }
  ...
  QueryBuilder<Person, Person, QAfterSortBy> thenByShowBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showBalance', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> thenByShowBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showBalance', Sort.desc);
    });
  }
...
extension PersonQueryWhereDistinct on QueryBuilder<Person, Person, QDistinct> {
  ...
  QueryBuilder<Person, Person, QDistinct> distinctByIsArchived() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QDistinct> distinctByShowBalance() {
    return QueryBuilder.apply(this, (query) {
...
extension PersonQueryProperty on QueryBuilder<Person, Person, QQueryProperty> {
  ...
  QueryBuilder<Person, double, QQueryOperations> balanceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'balance');
    });
  }

  QueryBuilder<Person, bool, QQueryOperations> isArchivedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, bool, QQueryOperations> showBalanceProperty() {
    return QueryBuilder.apply(this, (query) {
